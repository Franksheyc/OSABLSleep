...
[C11,c1d1]=bilif(C3t,C3t,[1 2  6],2);%此时刻的eeg与上一时刻的eeg（6段）
[C12,c1d2]=bilif(C4t,C4t,[1 2  6],2);
[M,md]=bilif(EMG,EMG,[1 2  6],1);%此时刻与上一时刻的emg（5段）
[C01,c0d1]=bilif(C32(:,27:end),C32(:,27:end),[1 2  6],4);
[C02,c0d2]=bilif(C42(:,27:end),C42(:,27:end),[1 2  6],4);
[CM1,cmd1]=bilif(C32(:,27:end),EMG2,[1  2  6],3);%同一时刻eeg与emg比例
